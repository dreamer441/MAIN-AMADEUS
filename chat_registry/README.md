...
It wraps `ChatHistoryStore` and returns only a chat ID, title, description,
...
Scope is descriptive in Registry V2. It does not trigger automatic cross-chat
retrieval or grant Flow access to any dedicated-chat history.
