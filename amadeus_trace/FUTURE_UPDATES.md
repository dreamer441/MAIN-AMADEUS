# AMADEUS Trace / Process Monitor Future Updates

- Add GUI filters by category and level.
- Add export trace to JSON or Markdown.
- Add persistent trace logs for debugging sessions.
- Add module-specific trace hooks for exact file reading, mind map, permissions, and skills.
